...
export const certificates: Certificate[] = [
  { id: 1, title: '2026-1학기 동행 활동 확인서', issuer: '서로대 학생지원센터 · ONDA', date: '2026.06.30 발급예정' },
  { id: 2, title: '배리어프리 서포터즈 활동 확인서', issuer: '학생복지위원회', date: '2026.04.15' },
  { id: 3, title: '봉사시간 누적 인증서 (30h+)', issuer: 'ONDA', date: '2026.03.20' },
];
...
export const matchRequests: Companion[] = [
  {
    ...
    status: '모집 중', verified: true, schoolPartner: true, volunteerHours: 4, mannerScore: 4.8,
  },
  {
    ...
    status: '대기 중', verified: true, volunteerHours: 2, mannerScore: 4.9,
  },
  {
    ...
    status: '모집 중', verified: true, volunteerHours: 1.5, mannerScore: 5.0,
  },
];
...
export const matchOffers: Companion[] = [
  {
    ...
    status: '모집 중', verified: true, schoolPartner: true, volunteerHours: 3, mannerScore: 4.9,
  },
  {
    ...
    status: '모집 중', verified: true, volunteerHours: 4, mannerScore: 4.7,
  },
];
...
export const myMatches: MyMatch[] = [
  ...
  },
  {
    ...
    purpose: '오랜만에 캠퍼스 한 바퀴 걷고 싶어요',
    location: '정문 → 후문', date: '2026.05.23 (토)', duration: '10:00 - 11:30',
    tags: ['산책'], needs: [], status: '대기 중', step: 1,
  },
];

export const matchSteps = ['요청 접수', '상대 찾기', '일정 조율', '동행', '마무리'] as const;
...
export const sosTargets: SosTarget[] = [
  ...
  { id: 'support',  label: '학교 학생지원센터', sub: '평일 09:00 - 18:00', phone: '02-***-****' },
...
export const hotPosts: HotPost[] = [
  { id: 1, board: '자유게시판', title: '오늘 학생식당 추천 메뉴 공유해요',          likes: 87,  comments: 24, views: 1203, isHot: true  },
  { id: 2, board: '정보게시판', title: '중앙도서관 엘리베이터 점검 안내 (5/22)', likes: 45,  comments: 12, views: 892,  isHot: true  },
  { id: 3, board: '동행후기',   title: '동행 매칭 후기 - 편하게 이동할 수 있었어요', likes: 132, comments: 38, views: 2104, isHot: true  },
  { id: 4, board: '질문게시판', title: '컴퓨터공학 전공 시간표 팁 공유 부탁드려요', likes: 18,  comments: 9,  views: 421,  isHot: false },
];

export const deadlineActivities: ActivityCard[] = [
  { id: 1, org: '학생복지위원회', title: '배리어프리 캠퍼스 서포터즈 2기', deadline: 'D-3',  deadlineLabel: '마감임박', deadlineColor: '#D97706', category: '교내활동', accessibility: ['엘리베이터', '수어통역'], progress: 85 },
  { id: 2, org: 'ONDA',     title: '정기 동행 모임 모집',  deadline: 'D-7',  deadlineLabel: '곧 마감', deadlineColor: '#B45309', category: '동행',     accessibility: ['이동 보조', '자막'],  progress: 62 },
  { id: 3, org: '교내 창업동아리', title: '편한 캠퍼스 아이디어 모임',         deadline: 'D-14', deadlineLabel: '여유',    deadlineColor: '#047857', category: '캠페인',   accessibility: ['자막', '온라인'],     progress: 35 },
];

export const campusNews: CampusNews[] = [
  { id: 1, tag: '학사', title: '2026-1학기 수강신청 변경 기간 안내', summary: '5월 20일~22일 학과별 변경 신청 접수',     date: '05.18' },
  { id: 2, tag: '지원', title: '학생지원센터 5월 프로그램 안내',  summary: '학습 멘토링 및 이동 지원 신청 모집',       date: '05.17' },
  { id: 3, tag: '행사', title: '캠퍼스 편한 이동 토크 콘서트',           summary: '5월 30일 학생회관 1층 / 수어통역 제공',    date: '05.15' },
];

export const externalActivities: ExternalActivity[] = [
  { id: 1, org: '한국장애인고용공단', title: '대학생 인식개선 콘텐츠 챌린지', deadline: 'D-5',  deadlineColor: '#D97706', category: '챌린지',  benefit: '상금 300만원' },
  { id: 2, org: 'SK행복나눔재단',     title: 'SUNNY 대학생 자원봉사 17기',   deadline: 'D-10', deadlineColor: '#B45309', category: '서포터즈', benefit: '활동비 + 수료증' },
  { id: 3, org: '카카오임팩트',       title: '편한 이동 앱 아이디어 프로그램',         deadline: 'D-21', deadlineColor: '#047857', category: '프로그램',  benefit: '멘토링 + 시상' },
];
